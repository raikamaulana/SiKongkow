...
public class RoundedPasswordField extends JPasswordField { // <-- Beda di sini
    ...
    public RoundedPasswordField() {
        ...
        // Atur padding (atas, kiri, bawah, kanan) agar teks tidak mepet
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Panggil super.paintComponent(g) untuk menggambar titik-titik password
    ...
    protected void paintBorder(Graphics g) {
        ...
        // Gambar border bulat
        g2.setColor(getForeground()); // Anda bisa ganti warnanya jika mau
